...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-screen h-[100%] flex justify-center items-center p-4"
    >
      <form
        method="POST"
      ...
      >
        <div className="pb-8">
          ...
          <p className="py-4">
            //send me a form if you have any comments, complaints, or conspiracy
            theories - c.kwokhong@gmail.com
          </p>
        </div>
        <input
